...
|---------|---------|-------------|--------------|
| Command | Example | Description | Installation Instructions |
...
| [npm](https://www.npmjs.com/) | `npm install -g package` | The Node.js package manager. | sudo apt install npm |
| [nvm](https://github.com/nvm-sh/nvm) | `nvm install 16` | Node Version Manager, to manage Node.js versions. | curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.39.5/install.sh | bash |
...
| [unrar](https://man7.org/linux/man-pages/man1/unrar.1.html) | `unrar x archive.rar` | Extract .rar files. | sudo apt install unrar |
| [unzip](https://man7.org/linux/man-pages/man1/unzip.1.html) | `unzip archive.zip` | Extract compressed .zip files. | sudo apt install unzip |
