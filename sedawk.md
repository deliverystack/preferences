...
### Use Case: Extract the second column of a CSV file, sort it, and remove duplicates.
```bash
...
### Use Case: Find lines containing "error", modify the text, and count occurrences.
```bash
